...
class ViewFamilyRelationsFromAPersonControllerIT {
    ...
    void getAnEmptyFamilyRelationListFromAPerson() throws Exception {
        ...
        VOPersonDTO voPersonDTO = new VOPersonDTO(name,birthDate,vat,address,telephoneNumberList,adminEmailSimpson,familyID,new LedgerID(UUID.randomUUID()));
    ...
    void getFamilyRelationListFromAPerson() throws Exception{
        ...
        VOPersonDTO voPersonDTO = new VOPersonDTO(martyName,martyBirthDate,martyVat,address,martyNumberList,adminEmailMcFly,familyID,new LedgerID(UUID.randomUUID()));
        ...
        VOPersonDTO georgeDTO = new VOPersonDTO(georgeName,georgeBirthDate,georgeVat,address,georgeNumberList,georgeID,familyID,new LedgerID(UUID.randomUUID()));
        ...
        VOPersonDTO loraineDTO = new VOPersonDTO(loraineName,loraineBirthDate,loraineVat,address,loraineNumberList,loraineID,familyID,new LedgerID(UUID.randomUUID()));
