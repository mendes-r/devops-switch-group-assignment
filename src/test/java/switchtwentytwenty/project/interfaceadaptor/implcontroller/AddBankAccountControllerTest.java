...
class AddBankAccountControllerTest {
    ...
    void AddBankSavingsAccount() throws Exception {
        ...
        InCreateAccountDTO info = new InCreateAccountDTO(designation, email, accountType);


        when(accountService.addBankAccount(designation, email,accountType)).thenReturn(Mockito.mock(OutAccountDTO.class));
