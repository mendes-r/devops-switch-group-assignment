...
class TransferBetweenTwoCashAccountsControllerIT {
    ...
    void testToTransferAValidAmountFromAMemberToAnotherMemberCashAccount() throws Exception {
        ...
        VOFamilyDTO familyDTO = new VOFamilyDTO(familyID, familyLedgerID, new Email(adminID), new FamilyName("Churchill"));
        ...
        VOPersonDTO voPersonDTO = new VOPersonDTO(martyName, martyBirthDate, martyVat, address, martyTelephoneNumberList, martyID, familyID, martyLedgerID);
        ...
        VOPersonDTO georgeDTO = new VOPersonDTO(georgeName, georgeBirthDate, georgeVat, address, georgeTelephoneNumberList, georgeID, familyID, georgeLedgerID);
        ...
        InTransferDTO info = new InTransferDTO();
    ...
    void testToTransferAValidAmountFromFamilyToPersonCashAccount() throws Exception {
        ...
        VOPersonDTO voPersonDTO = new VOPersonDTO(name, birthDate, vat, address, telephoneNumberList, personID, familyID, personLedgerID);
        ...
        InTransferDTO inTransferDTO = new InTransferDTO();
        inTransferDTO.setSenderId(familyID.toString());
        inTransferDTO.setReceiverId(adminID);
        inTransferDTO.setOriginAccountId(familyAccountID.toString());
        inTransferDTO.setDestinationAccountId(personAccountID.toString());
        inTransferDTO.setAmount(70);
        inTransferDTO.setDescription(transactionDescription.toString());
        inTransferDTO.setCategoryId(categoryID.toString());
        inTransferDTO.setDate(date.toString());
        ...
        //act
        ResponseEntity<Object> result = transferBetweenMembersCashController.transferBetweenTwoCashAccounts(inTransferDTO);
        int expected = 201;
