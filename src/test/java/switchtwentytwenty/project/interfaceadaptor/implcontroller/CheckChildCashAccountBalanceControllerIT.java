...
class CheckChildCashAccountBalanceControllerIT {
    ...
    void checkChildCashAccountBalance() throws Exception{
        ...
        VOFamilyDTO familyDTO = new VOFamilyDTO(familyID,new LedgerID(UUID.randomUUID()),new Email(adminID),new FamilyName("Costa"));
        ...
        VOPersonDTO voPersonDTO = new VOPersonDTO(parentName, parentBirthDate, parentVat, address, parentTelephoneNumberList, parentID, familyID, new LedgerID(UUID.randomUUID()));
        Person parent = PersonFactory.create(voPersonDTO);
        ...
        VOPersonDTO childDTO = new VOPersonDTO(childName, childBirthDate, childVat, address, childTelephoneNumberList, childID, familyID, new LedgerID(UUID.randomUUID()));
    ...
    void checkChildCashAccountBalance_PersonIsNotTheParent() throws Exception{
        ...
        UUID familyUUID = UUID.randomUUID();
        FamilyID familyID = new FamilyID(familyUUID);
        VOFamilyDTO familyDTO = new VOFamilyDTO(new FamilyID(familyUUID),new LedgerID(UUID.randomUUID()),new Email(adminID),new FamilyName("Costa"));
        Family family = FamilyFactory.create(familyDTO);
        familyRepository.save(family);
        ...
        VOPersonDTO cousinDTO = new VOPersonDTO(cousinName, cousinBirthDate, cousinVat, address, cousinTelephoneNumberList, cousinID, familyID, new LedgerID(UUID.randomUUID()));
