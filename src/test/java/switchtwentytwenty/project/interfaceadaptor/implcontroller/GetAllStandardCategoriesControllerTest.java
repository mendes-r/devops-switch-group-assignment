...
public class GetAllStandardCategoriesControllerTest {
    ...
    void getAllStandardCategories_OneCategory() {
        ...
        OutStandardCategoryDTO expectedDto = new OutStandardCategoryDTO(designation, id, parentID);
        List<OutStandardCategoryDTO> expected = new ArrayList<>();
    ...
    void getAllStandardCategories_SeveralCategories() {
        ...
        OutStandardCategoryDTO expectedDto = new OutStandardCategoryDTO(designation, id, parentID);
        OutStandardCategoryDTO otherExpectedDto = new OutStandardCategoryDTO(otherDesignation, otherId, otherParentID);
        List<OutStandardCategoryDTO> expected = new ArrayList<>();
        expected.add(expectedDto);
