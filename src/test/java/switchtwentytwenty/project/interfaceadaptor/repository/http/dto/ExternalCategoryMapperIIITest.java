...
class ExternalCategoryMapperIIITest {
    ...
    void toStandardDTO_WithoutParentID() {
        ...
        List<ExternalStandardCategoryDTOIII> list = new ArrayList<>();
        ExternalStandardCategoryDTOIII category = new ExternalStandardCategoryDTOIII();
        ...
        //act
        List<StandardCategoryDTO> result = ExternalCategoryMapperIII.toStandardDTO(list);
        //arrange
