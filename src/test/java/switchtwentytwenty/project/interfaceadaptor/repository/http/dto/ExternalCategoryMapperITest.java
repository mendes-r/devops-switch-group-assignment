...
class ExternalCategoryMapperITest {
    ...
    void toStandardDTO_WithoutParentID() {
        ...
        List<ExternalStandardCategoryDTOI> list = new ArrayList<>();
        ExternalStandardCategoryDTOI category = new ExternalStandardCategoryDTOI();
        category.setId(id);
        ...
        //act
        List<StandardCategoryDTO> result = ExternalCategoryMapperI.toStandardDTOList(list);
        //arrange
