...
class AccountServiceTest {
    ...
    void createPersonalCashAccount_Success() throws Exception {
        ...
        when(accountDGenerator.generate()).thenReturn(new AccountID(UUID.randomUUID()));
        //act - assert
        OutPersonalCashAccountDTO result = service.createPersonalCashAccount(holderID, initialAmount, designation);
    ...
    void createFamilyCashAccount_Success() throws Exception {
        ...
        //act - assert
        OutFamilyCashAccountDTO result = service.createFamilyCashAccount(holderID, initialAmount, designation);
        assertNotNull(result);
    ...
    void createFamilyCashAccount_NotFamilyAdministrator() throws Exception {
        ...
        //act - assert
        assertThrows(IllegalArgumentException.class, () -> service.createFamilyCashAccount(holderID, initialAmount, designation));
    }
    ...
    @Test
    @DisplayName("create Family Cash Account - Unsuccessful case: Not a family administrator")
    void createFamilyCashAccount_Unsuccessful() throws Exception {
        //arrange
        String designation = "Account";
        String holderID = "email@gmail.com";
        double initialAmount = 10;
    ...
    void createFamilyCashAccount_InvalidAmount() throws Exception {
        ...
        when(family.hasCashAccount()).thenReturn(false);
        //act - assert
        assertThrows(AccountNotCreatedException.class, () -> service.createFamilyCashAccount(holderID, initialAmount, designation));
    }
    ...
    void createFamilyCashAccount_InvalidEmail() {
        ...
        String holderID = "emailgmail.com";
        double initialAmount = 10;
        //act - assert
        assertThrows(InvalidEmailException.class, () -> service.createFamilyCashAccount(holderID, initialAmount, designation));
    }
    ...
    void addCreditAccountSuccessfullyWithDTO() throws Exception {
        ...
        doNothing().when(personRepository).save(person);
        //act - assert
        OutAccountDTO result = service.addBankAccount(designation, personIDString, accountType);
        assertNotNull(result);
    }
