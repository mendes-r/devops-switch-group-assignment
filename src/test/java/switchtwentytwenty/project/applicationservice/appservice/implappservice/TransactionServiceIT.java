...
class TransactionServiceIT {
    ...
    void testToTransferAValidAmountFromFamilyToPersonCashAccount() throws Exception {
        ...
        VOFamilyDTO voFamilyDTO = new VOFamilyDTO(familyID, familyLedgerID, personID, familyName);

        Family family = FamilyFactory.create(voFamilyDTO);
        ...
        VOPersonDTO voPersonDTO = new VOPersonDTO(name, birthDate, vat, address, telephoneNumberList, personID, family.getID(),
                personLedgerID);
    ...
    void testToTransferAnAmountFromFamilyToAPersonWhoDoesNotBelongToFamily() throws Exception {
        ...
        VOPersonDTO voPersonDTO = new VOPersonDTO(name, birthDate, vat, address, telephoneNumberList, personID, familyID1,
                personLedgerID);
        Person person = PersonFactory.create(voPersonDTO);
        personRepository.save(person);
    ...
    void testToTransferAnAmountFromFamilyToAPersonWhoIsNotTheAccountHolder() throws Exception {
        ...
        VOPersonDTO voPersonDTO1 = new VOPersonDTO(name, birthDate, vat, address, telephoneNumberList, personID, family.getID(),
                personLedgerID);
        ...
        VOPersonDTO voPersonDTO2 = new VOPersonDTO(name2, birthDate2, vat2, address2, telephoneNumberList2, personID2, family.getID(),
                personLedgerID2);
    ...
    void testToTransferAnAmountFromPersonToAPerson() throws Exception {
        ...
        VOFamilyDTO voFamilyDTO = new VOFamilyDTO(familyID, familyLedgerID, martyID, familyName);
        Family family = FamilyFactory.create(voFamilyDTO);
        familyRepository.save(family);
        ...
        VOPersonDTO voPersonDTO1 = new VOPersonDTO(martyName, martyBirthDate, martyVat, address, martyTelephoneNumberList, martyID, family.getID(),
                martyLedgerID);
        Person marty = PersonFactory.create(voPersonDTO1);
        ...
        VOPersonDTO voPersonDTO2 = new VOPersonDTO(georgeName, georgeBirthDate, georgeVat, address, georgeTelephoneNumberList,
                georgeID, family.getID(), georgeLedgerID);
        Person george = PersonFactory.create(voPersonDTO2);
    ...
    void testToTransferAValidAmountFromPersonToAPersonWhoIsNotInTheSameFamily() throws Exception {
        ...
        VOFamilyDTO voFamilyDTO1 = new VOFamilyDTO(familyID, familyLedgerID, martyID, familyName);
        Family family1 = FamilyFactory.create(voFamilyDTO1);
        ...
        VOFamilyDTO voFamilyDTO2 = new VOFamilyDTO(familyID2, familyLedgerID2, georgeID, familyName2);
        Family family2 = FamilyFactory.create(voFamilyDTO2);
        ...
        VOPersonDTO voPersonDTO1 = new VOPersonDTO(martyName, martyBirthDate, martyVat, address, martyTelephoneNumberList, martyID, family1.getID(),
                martyLedgerID);
        Person marty = PersonFactory.create(voPersonDTO1);
        personRepository.save(marty);
