...
class FamilyServiceTest {
    ...
    void getFamilyProfileSuccessfully() throws Exception {
        ...
        //act
        OutFamilyProfileDTO result = familyService.getFamilyProfile(familyID);
        //assert
    ...
    void getListOfSystemRelations() {
        ...
        OutSystemRelationsDTO expected = new OutSystemRelationsDTO(relationsList);
        //act
        OutSystemRelationsDTO result = familyService.getSystemRelations();
        //assert
