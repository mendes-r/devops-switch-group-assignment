...
class FamilyAndMemberServiceIT {
    ...
    void getAnEmptyFamilyRelationListFromAPerson() throws Exception {
        ...
        VOPersonDTO voPersonDTO = new VOPersonDTO(name, birthDate, vat, address, telephoneNumberList, adminEmailSimpson, familyID,
                new LedgerID(UUID.randomUUID()));
        Person person = PersonFactory.create(voPersonDTO);
        personRepository.save(person);
        VOFamilyDTO familyDTO = new VOFamilyDTO(familyID, new LedgerID(UUID.randomUUID()), adminEmailSimpson, familyNameSimpson);
    ...
    void getFamilyRelationListFromAPerson() throws Exception {
        ...
        VOPersonDTO voPersonDTO = new VOPersonDTO(martyName, martyBirthDate, martyVat, address, martyNumberList, adminEmailMcFly, familyID,
                new LedgerID(UUID.randomUUID()));
        Person marty = PersonFactory.create(voPersonDTO);
        personRepository.save(marty);

        //Create family and add to family repository
        VOFamilyDTO familyDTO = new VOFamilyDTO(familyID, new LedgerID(UUID.randomUUID()), adminEmailMcFly, familyNameMcFly);
        Family family = FamilyFactory.create(familyDTO);
        familyRepository.save(family);
        ...
        VOPersonDTO georgeDTO = new VOPersonDTO(georgeName, georgeBirthDate, georgeVat, address, georgeNumberList, georgeID, familyID,
                new LedgerID(UUID.randomUUID()));
        ...
        VOPersonDTO loraineDTO = new VOPersonDTO(loraineName, loraineBirthDate, loraineVat, address, loraineNumberList, loraineID, familyID,
                new LedgerID(UUID.randomUUID()));
        ...
        //act
        OutViewRelationDTO relationDTO = familyAndMemberService.getFamilyRelationByPersonID("marty_mcfly@gmail.com");
    ...
    void createFamilyRelationNullRelationType() throws Exception {
        ...
        VOPersonDTO voPersonDTO = new VOPersonDTO(
                ...
                new LedgerID(UUID.randomUUID()));
        Person maggy = PersonFactory.create(voPersonDTO);
        personRepository.save(maggy);

        VOPersonDTO johnnyDTO = new VOPersonDTO(
    ...
    void addFamilyMemberSuccessfully() throws Exception {
        //arrange
        VOFamilyDTO familyDTO = new VOFamilyDTO(new FamilyID(UUID.randomUUID()),new LedgerID(UUID.randomUUID()),new Email("admin@gmail.com"),new FamilyName("Constantino"));
        Family family = FamilyFactory.create(familyDTO);
        familyRepository.save(family);
    ...
    void createAFamilyRelationSuccessfully() throws Exception {
        //arrange
        int result;
        int expected = 1;
        ...
        VOPersonDTO voDTO = new VOPersonDTO(
                new PersonName("Johnny"),
    ...
    void createRetrieveSaveFamily() throws Exception {
        //arrange
        List<String> phoneNumbers = new ArrayList<>();
        phoneNumbers.add("912343546");
        ...
        FamilyAndAdminDTO dto = new FamilyAndAdminDTO("Margaret Hamilton","1904-12-01","213025086","14","Logical Street",
                "Porto","Portugal","2100-345",phoneNumbers,"bones@gmail.com","Hamilton");
        familyAndMemberService.startFamily(dto);
        ...
        //act
        accountService.createFamilyCashAccount(email.toString(), 200, "Family cash account");
    ...
    void startFamilySuccessfully() {
        ...
        johnPhoneNumbers.add("912343546");
        FamilyAndAdminDTO dto = new FamilyAndAdminDTO("Margaret Hamilton","1904-12-01","213025086","14","Logical Street",
                "Porto","Portugal","2100-345",johnPhoneNumbers,"bones@gmail.com","Hamilton");
        //act - assert
    ...
    void startFamilyInvalidAdminEmail() {
        ...
        FamilyAndAdminDTO dto = new FamilyAndAdminDTO("Margaret Hamilton","1996-12-12","250054906","14","Logical Street",
                "Porto","Portugal","2100-345",johnPhoneNumbers,"bonesgmail.com","Hamilton");
        //act - assert
    ...
    void startFamily_administratorIDAlreadyUsed() throws Exception {
        //arrange
        //family bones
        FamilyAndAdminDTO bones = new FamilyAndAdminDTO("John Bones","1996-12-12","250054906","14","Logical Street",
                "Porto","Portugal","2100-345",null,"bones@gmail.com","Hamilton");
        //family adams
    ...
    void startFamily_addTwoFamiliesSuccessfully() {
        ...
        //family adams
        FamilyAndAdminDTO adams = new FamilyAndAdminDTO("John Adams","1996-12-12","277220777","14","Logical Street",
                "Porto","Portugal","2100-345",null,"adams@gmail.com","Hamilton");
        //act & assert
    ...
    void testAreFromTheSameHousehold() throws Exception {
        ...
        VOPersonDTO indyDTO = new VOPersonDTO(indyName,birthDate,vat,address,telephoneNumberList,indyID,familyID1,ledgerID);
        Person indy = PersonFactory.create(indyDTO);
        personRepository.save(indy);

        VOPersonDTO otherIndyDTO = new VOPersonDTO(indyName,birthDate,vat,address,telephoneNumberList,otherindyID,familyID2,ledgerID);
