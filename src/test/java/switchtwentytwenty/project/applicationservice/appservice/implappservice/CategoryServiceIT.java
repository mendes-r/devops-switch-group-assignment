...
class CategoryServiceIT {
    ...
    void getStandardCategoriesTree() throws Exception {
        ...
        OutCategoryTreeDTO outCategoryTreeDTO = new OutCategoryTreeDTO("Food");
        OutCategoryTreeDTO outCategoryTreeDTO1 = new OutCategoryTreeDTO("Fruit");
        OutCategoryTreeDTO outCategoryTreeDTO2 = new OutCategoryTreeDTO("Meat");
        OutCategoryTreeDTO outCategoryTreeDTO3 = new OutCategoryTreeDTO("Fish");
        outCategoryTreeDTO.addChildTree(outCategoryTreeDTO1);
        outCategoryTreeDTO.addChildTree(outCategoryTreeDTO2);
        outCategoryTreeDTO.addChildTree(outCategoryTreeDTO3);
        List<OutCategoryTreeDTO> expected = new ArrayList<>();
        expected.add(outCategoryTreeDTO);

        //act
        List<OutCategoryTreeDTO> standardTree = categoryService.getStandardCategoriesTree();
    ...
    void createRootCustomCategorySuccess() throws Exception {
        ...
        //act
        OutCustomCategoryDTO customRoot = categoryService.createRootCustomCategory(dto);

        OutCustomCategoryDTO customCategoryDTO = new OutCustomCategoryDTO("Bills");
    ...
    void createCustomChildCategory(){
        ...
        //act
        OutCustomCategoryDTO customCategoryDTO = categoryService.createChildCustomCategory(dto);
    ...
    @Test
    @DisplayName("Create child custom category - same designation as OutCustomCategoryDTO")
    void sameDesignationAsOutDTO() {
        ...
        OutCustomCategoryDTO customCategoryDTO = new OutCustomCategoryDTO("Roupa Criança");
    ...
    @Test
    @DisplayName("Same designation as OutCategoryTreeDTO")
    void sameDesignationAsOutTreeDTO() {
        ...
        OutCategoryTreeDTO treeDTO = new OutCategoryTreeDTO("Bills");
    ...
    void sameDesignationAsChildCategoriesDTO() {
        ...
        OutCategoryTreeDTO treeDTO = new OutCategoryTreeDTO("Roupa");
        OutCategoryTreeDTO childTreeDTO = new OutCategoryTreeDTO("Roupa Criança");
    ...
    void createChildStandardCategory() throws Exception {
        ...
        //act
        OutStandardCategoryDTO standard = categoryService.createChildStandardCategory("Fruit", parseRootId);
    ...
    void getStandardCategoriesTreeSuccess() throws Exception {
        ...
        OutCategoryTreeDTO treeRoot = new OutCategoryTreeDTO(rootDesignation.toString());
    ...
    void getChildCategoriesListEmpty() throws ElementNotFoundException, DesignationNotPossibleException {
        ...
        List<OutCategoryTreeDTO> categoriesList = categoryService.getStandardCategoriesTree();
    ...
    void getStandardChildCategories() throws ElementNotFoundException, DesignationNotPossibleException {
        ...
        List<OutCategoryTreeDTO> categories = categoryService.getStandardCategoriesTree();
        List<OutCategoryTreeDTO> children = categories.get(0).getChildren();
        int expected = 2;
    ...
    void constructTreeWithMultipleCategoryChildren() throws Exception {
        ...
        //act
        List<OutCategoryTreeDTO> result = categoryService.getStandardCategoriesTree();
        //assert
        assertNotNull(result);
        for (OutCategoryTreeDTO categoryTreeDTO : result) {
    ...
    void getListOfStandardCategories() {
        //arrange
        List<OutStandardCategoryDTO> outList = new ArrayList<>();
        ...
        //act
        OutStandardCategoryDTO outStandardCategoryDTO = OutStandardCategoryDTOMapper.toDTO(parentCategory);
        outList.add(outStandardCategoryDTO);
        List<OutStandardCategoryDTO> result = categoryService.getListOfStandardCategories();
    ...
    void getTheRightCategoryID() throws ElementNotFoundException {
        ...
        categoryRepository.save(parentCategory);
        //act
        OutCategoryDTO dto = categoryService.getCategoryByID(Id.toString());
    ...
    void createRootStandardCategorySuccess() throws Exception {
        ...
        //act
        OutStandardCategoryDTO standardRoot = categoryService.createRootStandardCategory(designation);
