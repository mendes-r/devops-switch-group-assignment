...
public class LedgerServiceIT {
    ...
    void getListOfMovementsBetweenDates() throws Exception {
        ...
        Account cashAccount = (CashAccount) AccountFactory.createCashAccount(accountID, accountDesignation,amountValue);
        ...
        //act
        List<OutMovementDTO> listOfMovementsBetweenDates = ledgerService.getListOfMovementsBetweenDates(adminEmail, accountID.toString(), startDate, endDate);
    ...
    void getListOfMovementsBetweenDatesDatesWrongOrder() throws Exception {
        ...
        //act
        List<OutMovementDTO> dtoList = ledgerService.getListOfMovementsBetweenDates(adminEmail, accountID.toString(), endDate, startDate);
        result = dtoList.size();
