...
class PersonDomainDataAssemblerIT {
    ...
    void personAssemblerToDataWithSeveralEmails() throws Exception {
        ...
        VOPersonDTO voPersonDTO = new VOPersonDTO(name, birthDate, vat, address, telephoneNumberList, personID, familyID, ledgerID);
    ...
    void personAssemblerToDomainWithSeveralEmails() throws Exception {
        ...
        //act
        JpaToDomainPersonDTO person = assembler.toDomain(personJPA);
        //assert
