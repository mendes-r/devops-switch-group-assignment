...
class InCustomCategoryDTOTest {

    @Test
    void toStringTestSuccess() {
        String designation = "Food";
        String parentID = "234jsj";
        InCustomCategoryDTO customCategoryDTO = new InCustomCategoryDTO(designation, parentID);
    ...
    void getParentID() {
        ...
        InCustomCategoryDTO dto= new InCustomCategoryDTO(designation, parentID);
        // act
