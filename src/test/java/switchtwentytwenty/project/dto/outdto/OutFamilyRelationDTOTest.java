...
public class OutFamilyRelationDTOTest {
    ...
    void testGetters() {
        ...
        OutFamilyRelationDTO dto = new OutFamilyRelationDTO(personID, kinID, relationType);
        //act
    ...
    void sameObject() {
        ...
        //act
        OutFamilyRelationDTO sameDto = dto;
    ...
    void identicalObject() {
        ...
        //act
        OutFamilyRelationDTO sameDto = new OutFamilyRelationDTO(personID, kinID, relationType);
    ...
    void nullObject() {
        ...
        //act
        OutFamilyRelationDTO otherDto = null;
    ...
    void differentObjects() {
        ...
        //act
        OutFamilyRelationDTO otherDto = new OutFamilyRelationDTO(personID, otherKinID, relationType);
        boolean result = dto.equals(otherDto);
    ...
    void identicalObjectButDifferentRelation() {
        ...
        //act
        OutFamilyRelationDTO sameDto = new OutFamilyRelationDTO(personID, kinID, otherRelationType);
    ...
    void testEqualsWithDifferentPersonID() {
        ...
        OutFamilyRelationDTO secondDto = new OutFamilyRelationDTO(secondPersonID, kinID, relationType);
