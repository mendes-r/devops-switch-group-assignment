...
public class OutMovementDTOTest {
    ...
    void identicalObject() {
        ...
        //act
        OutMovementDTO otherDto = new OutMovementDTO.OutMovementDTOBuilder()
                .withAmount(amount)
                .withAccountID(accountID)
                .withMovementType(movementType)
                .withDate(date)
    ...
    void OutMovementDTOEqualsWithADifferentDates() {
        ...
        OutMovementDTO secondDto = new OutMovementDTO.OutMovementDTOBuilder()
                .withAmount(value)
                .withAccountID(accountID)
                .withMovementType(movementType)
                .withDate(secondDate)
