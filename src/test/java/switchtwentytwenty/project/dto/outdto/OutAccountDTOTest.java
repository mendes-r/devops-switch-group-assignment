...
class OutAccountDTOTest {

    @Test
    @DisplayName("Create a valid OutAccountDTO")
    void createOutAccountDto() {
        //arrange
        OutAccountDTO dto = new OutAccountDTO("jac5","cashAccount");
        // act
        //assert
        assertNotNull(dto);
    }
    ...
    void testEqualsForDiferentDtos() {
        //arrange
        OutAccountDTO dto = new OutAccountDTO("jac5","cashAccount");
        OutAccountDTO secondDto = new OutAccountDTO("jac","cashAccount");
        // act
    ...
    void testEqualsForDiferentDesignation() {
        //arrange
        OutAccountDTO dto = new OutAccountDTO("jac5","cashAccount");
        OutAccountDTO secondDto = new OutAccountDTO("jac5","cash");
        // act
        boolean result = dto.equals(secondDto);
        //assert
        assertFalse(result);
    ...
    void testEqualsForSimilarDtos() {
        //arrange
        OutAccountDTO dto = new OutAccountDTO("jac5","cashAccount");
        OutAccountDTO secondDto = new OutAccountDTO("jac5","cashAccount");
        // act
        boolean result = dto.equals(secondDto);
        //assert
        assertTrue(result);
    ...
    void testHashCodeForDifferentDtos() {
        //arrange
        OutAccountDTO dto = new OutAccountDTO("jac53","cashAccount");
        OutAccountDTO secondDto = new OutAccountDTO("jac5","cashAccount");
        // act
        int firstHashCode = dto.hashCode();
        int secondHashCode = secondDto.hashCode();
