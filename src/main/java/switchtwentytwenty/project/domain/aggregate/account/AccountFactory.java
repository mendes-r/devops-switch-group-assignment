...
public class AccountFactory {
    ...
    public static Account createAccount(JpaToDomainAccountDTO jpaToDomainAccountDTO) throws AccountNotCreatedException {
        String accountType = jpaToDomainAccountDTO.getAccountType();
        AccountID accountID = jpaToDomainAccountDTO.getAccountID();
        AccountDesignation designation = jpaToDomainAccountDTO.getAccountDesignation();
        if (accountType.equals(Constants.CASH_ACCOUNT_TYPE)) {
            MoneyValue cashAmount = jpaToDomainAccountDTO.getCashAmount();
