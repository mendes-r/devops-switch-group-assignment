...
public class PersonDomainAssembler {
    ...
    /**
     * Map to person dto.
     * @param personDTO - in person dto.
     * @return The person dto.
     */
    public static VOPersonDTO toDomain(PersonDTO personDTO, LedgerID ledgerID) throws InvalidPersonNameException, InvalidEmailException,
            InvalidDateException, InvalidVATException {
        ...
        return new VOPersonDTO(personName, birthDate, vat, address, telephoneNumberList, email, familyID, ledgerID);
    }
}
