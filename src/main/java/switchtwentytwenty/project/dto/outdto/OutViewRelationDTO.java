...
public class OutViewRelationDTO extends RepresentationModel<OutViewRelationDTO> {
     ...
     */
    public OutViewRelationDTO(List<String> relationList) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OutViewRelationDTO)) return false;
        OutViewRelationDTO that = (OutViewRelationDTO) o;
