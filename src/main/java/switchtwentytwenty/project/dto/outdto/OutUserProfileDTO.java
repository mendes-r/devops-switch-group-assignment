...
@NoArgsConstructor
public class OutUserProfileDTO extends RepresentationModel<OutUserProfileDTO> {
    ...
    public static class UserProfileDTOBuilder {
        ...
        private final OutUserProfileDTO dto;

        public UserProfileDTOBuilder() {
            this.dto = new OutUserProfileDTO();
        }
        ...
        public OutUserProfileDTO build() {
