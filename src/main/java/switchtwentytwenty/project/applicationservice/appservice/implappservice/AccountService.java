...
public class AccountService implements IAccountService {
    ...
    public OutPersonalCashAccountDTO createPersonalCashAccount(String personIDString, double cashAmount, String designation) throws
        ...
        return new OutPersonalCashAccountDTO(cashAccount.getID().toString(), cashAccount.getDesignation().toString());
    }
     ...
     */
    @Transactional(rollbackFor = Exception.class)
    public OutFamilyCashAccountDTO createFamilyCashAccount(String adminID, double cashAmount, String designation) throws ElementNotFoundException,
            AccountNotCreatedException, InvalidEmailException, IOException, InvalidRelationTypeException, InvalidDateException, InvalidVATException, InvalidPersonNameException {
        Email administratorID = new Email(adminID);
        Person admin = personRepository.findByID(administratorID);
        ...
        return new OutFamilyCashAccountDTO(cashAccount.getID().toString(), cashAccount.getDesignation().toString());
    }
     ...
     */
    @Transactional(rollbackFor = Exception.class)
    public OutAccountDTO addBankAccount(String designation, String personIDString, String accountType)
        ...
        this.personRepository.save(person);
        return new OutAccountDTO(bankAccountID.toString(), designation);
    }
     ...
     */
    public List<OutAccountDTO> getListOfAccounts(String personID) throws InvalidEmailException, InvalidDateException, ElementNotFoundException, InvalidVATException, InvalidPersonNameException, AccountNotCreatedException{
        Email email = new Email(personID);
        Person person = this.personRepository.findByID(email);
        List<OutAccountDTO> list = new ArrayList<>();
        ...
        for (String accountId : accountIDList) {
            ...
            OutAccountDTO dto = new OutAccountDTO(account.getID().toString(), account.getDesignation().toString());
            list.add(dto);
        }
        return list;
    }
