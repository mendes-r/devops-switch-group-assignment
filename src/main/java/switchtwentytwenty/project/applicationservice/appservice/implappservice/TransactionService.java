...
public class TransactionService implements ITransactionService {
     ...
     * @return an OutTransferDTO with some information
    ...
    private OutTransferDTO transferBetweenFamilyAndMember(TransferDomainDTO transferBetweenFamilyAndMemberDTO) throws InvalidEmailException, ParseException, ElementNotFoundException, InvalidVATException, InvalidDateException, InvalidPersonNameException, InstantiationException, AccountNotCreatedException, DepositNotPossibleException, IOException, WithdrawNotPossibleException, InvalidRelationTypeException, InvalidMovementTypeException, ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        ...
        if (isMemberFromFamily(familyID, receiverID) && areAccountHolders(transferBetweenFamilyAndMemberDTO)) {
            ...
            return new OutTransferDTO(transferBetweenFamilyAndMemberDTO.getOriginAccountID().toString(), transferBetweenFamilyAndMemberDTO.getDestinationAccountID().toString(), transferBetweenFamilyAndMemberDTO.getDate().toString(), transferBetweenFamilyAndMemberDTO.getAmount().toDouble());
    ...
    private OutTransferDTO transferBetweenMembers(TransferDomainDTO transferBetweenMemberAndMemberDTO) throws ParseException, AccountNotCreatedException, ElementNotFoundException, InstantiationException, DepositNotPossibleException, InvalidDateException, InvalidVATException, InvalidPersonNameException, InvalidRelationTypeException, InvalidMovementTypeException, WithdrawNotPossibleException, IOException, InvalidEmailException, ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        ...
        if (areFromSameFamily(senderID, receiverID) && areAccountHolders(transferBetweenMemberAndMemberDTO)) {
            ...
            return new OutTransferDTO(transferBetweenMemberAndMemberDTO.getOriginAccountID().toString(), transferBetweenMemberAndMemberDTO.getDestinationAccountID().toString(), transferBetweenMemberAndMemberDTO.getDate().toString(), transferBetweenMemberAndMemberDTO.getAmount().toDouble());
     ...
     * @throws InstantiationException     - instantiation's error
     */
    private boolean areCashAccounts(AccountID sender, AccountID receiver) throws ElementNotFoundException, AccountNotCreatedException, InstantiationException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, IOException {
     ...
     */
    @Transactional(rollbackFor = Exception.class)
    public OutPaymentDTO addPaymentTransaction(PaymentDTO dto) throws InvalidEmailException, InvalidDateException, ElementNotFoundException, InvalidVATException, InvalidPersonNameException, InstantiationException, InvalidMovementTypeException, ParseException, WithdrawNotPossibleException, AccountNotCreatedException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, IOException {
        Email personID = new Email(dto.getPersonID());
        ...
        if (person.isMyAccount(accountID)) {
            ...
            if (account.isCashAccount() && category.belongsToFamily(person.getFamilyID())) {
                ...
                return new OutPaymentDTO(description.toString(), accountID.toString(), category.toString(), amount.toDouble(), date.toString());
            }
            throw new UnsupportedOperationException("The account isn't a cash account");
        }
        throw new UnsupportedOperationException("Account doesn't belong to person");
    }
