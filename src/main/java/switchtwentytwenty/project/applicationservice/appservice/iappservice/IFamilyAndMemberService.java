...
public interface IFamilyAndMemberService {
     ...
     */
    Optional<OutFamilyRelationDTO> createFamilyRelation(String personEmail, String kinEmail, String familyIdentifier, String relationTypeName) throws IOException, InvalidRelationTypeException, InvalidEmailException, ElementNotFoundException, InvalidDateException, InvalidVATException, InvalidPersonNameException, ParseException, InvalidMovementTypeException, AccountNotCreatedException, InstantiationException;
     ...
     */
    OutViewRelationDTO getFamilyRelationByPersonID(String personID) throws InvalidEmailException, ElementNotFoundException, InvalidDateException, InvalidVATException, InvalidPersonNameException, IOException, InvalidRelationTypeException, InvalidMovementTypeException, ParseException, AccountNotCreatedException, InstantiationException;
     ...
     *                                        family.
     */
    OutPersonDTO addFamilyMember(PersonDTO personDTO)
     ...
     */
    OutFamilyAndAdminDTO startFamily(FamilyAndAdminDTO dto)
            throws PersonAlreadyInSystemException, InvalidEmailException, InvalidDateException, InvalidVATException, InvalidPersonNameException;
}
