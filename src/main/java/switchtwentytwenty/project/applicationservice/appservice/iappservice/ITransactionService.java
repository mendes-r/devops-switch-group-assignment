...
public interface ITransactionService {
     ...
     */
    OutPaymentDTO addPaymentTransaction(PaymentDTO dto) throws InvalidEmailException, InvalidDateException, ElementNotFoundException, InvalidVATException, InvalidPersonNameException, AccountNotCreatedException, InstantiationException, InvalidMovementTypeException, ParseException, WithdrawNotPossibleException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, IOException;
}
