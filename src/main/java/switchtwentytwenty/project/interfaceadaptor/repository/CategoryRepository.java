...
public class CategoryRepository implements ICategoryRepository {
    ...
    public Category findByID(CategoryID id) throws ElementNotFoundException {
        ...
        if (optionalCategoryJPA.isPresent()) {
            ...
            VOCategoryDTO voCategoryDTO = assembler.toDomain(categoryJPA);
            return CategoryFactory.create(voCategoryDTO);
        }
    ...
    public Category save(Category category) {
        ...
        VOCategoryDTO responseVOCategoryDTO = assembler.toDomain(responseCategoryJPA);
        return CategoryFactory.create(responseVOCategoryDTO);
    }
    ...
    public List<Category> getStandardCategories() {
        ...
        for (CategoryJPA categoryJPA : categories) {
            VOCategoryDTO voCategoryDTO = assembler.toDomain(categoryJPA);
            Category category = CategoryFactory.create(voCategoryDTO);
