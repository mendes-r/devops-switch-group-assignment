...
public class ExternalCategoryMapperIII {
     ...
     * @return an OutDTO
     */
    private static StandardCategoryDTO toStandardDTO(ExternalStandardCategoryDTOIII standard) {
     ...
     * @return an OutDTO
     */
    public static List<StandardCategoryDTO> toStandardDTO(List<ExternalStandardCategoryDTOIII> list) {
        List<StandardCategoryDTO> result = new ArrayList<>();
        for (ExternalStandardCategoryDTOIII dto : list) {
