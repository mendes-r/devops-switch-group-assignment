...
public class ExternalCategoryMapperI {
     ...
     * @return an OutDTO
     */
    private static StandardCategoryDTO toStandardDTO(ExternalStandardCategoryDTOI standard) {
     ...
     * @return an OutDTO
     */
    public static List<StandardCategoryDTO> toStandardDTOList(List<ExternalStandardCategoryDTOI> list) {
        List<StandardCategoryDTO> result = new ArrayList<>();
        for (ExternalStandardCategoryDTOI dto : list) {
