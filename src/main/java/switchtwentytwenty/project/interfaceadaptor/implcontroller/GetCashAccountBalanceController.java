...
public class GetCashAccountBalanceController implements IGetCashAccountBalanceController {
    ...
    public ResponseEntity<Object> getCashAccountBalance(@PathVariable String personId, @PathVariable String accountId) {
        try {
            ...
            Link linkToPerson = linkTo(methodOn(GetCashAccountBalanceController.class)
                    .getCashAccountBalance(personId, accountId))
                    .withRel("balance");

            OutCashAccountBalanceDTO response = new OutCashAccountBalanceDTO(cashAccountBalance);
