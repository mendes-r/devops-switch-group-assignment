...
import switchtwentytwenty.project.interfaceadaptor.icontroller.IGetListOfFamilyCategoriesController;
...
public class GetListOfFamilyCategoriesController implements IGetListOfFamilyCategoriesController {
    ...
    public ResponseEntity<Object> getListOfFamilyCategoriesController(@PathVariable(value = "familyID") String familyID) throws ElementNotFoundException {
        try {
            List<OutCategoryDTO> dtoList = categoryService.getListOfFamilyCategories(familyID);
            ...
            for (OutCategoryDTO outCategoryDTO : dtoList) {
                outCategoryDTO.add(allStandardLink);
            }
